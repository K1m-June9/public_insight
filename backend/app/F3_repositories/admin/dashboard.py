...
class DashboardAdminRepository:
    ...
    async def get_overview_stats(self) -> Dict[str, int]:
        ...
        user_result = await self.db.execute(user_counts_stmt)
        ...
        feed_result = await self.db.execute(feed_counts_stmt)
    ...
    async def get_slider_stats(self) -> Dict[str, int]:
        ...
        active, inactive = (await self.db.execute(stmt)).one()
    ...
    async def get_notice_stats(self) -> Dict[str, int]:
        ...
        active, inactive, pinned = (await self.db.execute(stmt)).one()
